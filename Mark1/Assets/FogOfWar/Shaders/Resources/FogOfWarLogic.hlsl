...
#pragma multi_compile_local FADE_LINEAR FADE_EXP FADE_SMOOTH FADE_SMOOTHER FADE_SMOOTHSTEP
...
#if USE_TEXTURE_BLUR
    float texSamp = SampleBlurredTexture(uv, 16);
#else
